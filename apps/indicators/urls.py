...
urlpatterns = [
    # Main dynamic view - order matters! Put more specific patterns first
    path('indicator/<str:indicator_code>/<str:view_type>/', views.indicator_view, name='indicator_view'),
    path('indicator/<str:indicator_code>/', views.indicator_view, {'view_type': 'chart'}, name='indicator_default'),
    
    # Backward compatibility (keep these for existing links)
